...
**역할:** 메인 개발 리드
**기술:** `Unity` `C#` `ASP.NET Core` `EF Core` `PostgreSQL` `WPF(XAML)` `MVVM` `JWT` `Git` `GitLab`
...
**기간:** 2023.12 ~ 2025.05 (약 1년 6개월, 단속적)
**역할:** Unity 개발
**기술:** `Unity` `C#` `Python` `VFX Graph` `Particle System` `Shader` `Compute Shader`
